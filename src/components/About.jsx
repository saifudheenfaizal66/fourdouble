...
export default function About({ onOpenQuote }) {
  ...
  const pillars = [
    {
      ...
      desc: 'Rapid MVP development, scalable web platforms, and modern brand identities engineered to win early users and traction.',
      badge: 'Scalable MVPs',
  ...
  return (
    <section id="about" className="py-16 sm:py-24 relative overflow-hidden bg-[#F8FAFC]">
      {/* Background Orbs */}
      ...
      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center mb-12 sm:mb-20">
          ...
          <div className="lg:col-span-7">
            ...
            {/* Stat Counters Grid (Mobile 3-card layout) */}
            <div className="grid grid-cols-3 gap-2 sm:gap-6 pt-5 sm:pt-6 border-t border-slate-200">
              {stats.map((stat, idx) => (
                <div key={idx} className="flex flex-col p-2.5 sm:p-4 rounded-xl sm:rounded-2xl bg-white sm:bg-transparent border sm:border-0 border-slate-200/80 shadow-2xs sm:shadow-none text-center sm:text-left">
          ...
          <div className="lg:col-span-5 w-full">
            <div className="p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-white border border-blue-100 shadow-[0_20px_50px_-10px_rgba(0,119,182,0.12)] relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 rounded-full blur-2xl pointer-events-none" />
              
              <div className="flex items-center gap-3 mb-5 sm:mb-6 pb-3 sm:pb-4 border-b border-slate-100">
                <div className="p-2 sm:p-2.5 rounded-xl bg-blue-50 text-[#0077B6] border border-blue-100">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="p-3.5 sm:p-4 rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-200/80 flex items-center justify-between">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-8">
          {pillars.map((pillar, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-white border border-slate-200/90 shadow-sm hover:shadow-xl transition-all duration-300 relative overflow-hidden flex flex-col justify-between hover:-translate-y-1"
              >
                ...
                <div>
                  <div className="flex items-center justify-between mb-4 sm:mb-6">
                    <div className="p-3 sm:p-3.5 rounded-xl sm:rounded-2xl border bg-blue-50/80 border-blue-100 text-[#0077B6]">
                      <Icon className="w-5 h-5 sm:w-6 sm:h-6 text-[#0077B6]" />
                    </div>
                    <span className="text-[11px] sm:text-xs font-bold px-2.5 sm:px-3 py-1 rounded-full border bg-slate-100 text-slate-700 border-slate-200">
                      {pillar.badge}
                    </span>
                  </div>
                ...
                <div className="flex items-center gap-2 text-xs font-bold pt-3.5 sm:pt-4 border-t text-[#0077B6] border-slate-100">
